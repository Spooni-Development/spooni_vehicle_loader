...
Citizen.CreateThread(function()
    ...
    PerformHttpRequest('https://raw.githubusercontent.com/Spooni-Development/spooni_updates/refs/heads/main/scripts/spooni_vehicle_loader.json', function(err, text, headers)
        ...
        if tonumber(version) == tonumber(data.version) then
            ...
            if escrow == true then
                ...
                print('^8Download: ^3https://github.com/Spooni-Development/spooni_vehicle_loader^0')
            end
        end
    end, 'GET')
end)
